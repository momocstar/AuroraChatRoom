 ...
 * @since 2018-06-23
 */
public abstract class AbstractServiceImpl<M extends BaseMapper<T>, T extends BasePojo> implements IBaseService<T> {
    ...
    protected Class<M> currentMapperClass() {
        return (Class<M>) ReflectionKit.getSuperClassGenericType(this.getClass(), AbstractServiceImpl.class, 0);
    }

    protected Class<T> currentModelClass() {
        return (Class<T>) ReflectionKit.getSuperClassGenericType(this.getClass(), AbstractServiceImpl.class, 1);
    }
